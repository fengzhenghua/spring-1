...
/**
 * Created by anson on 2017/1/12.
 */
public class MailRevice {
    private MimeMessage msg = null;
    private String saveAttchPath = "";
    private StringBuffer bodytext = new StringBuffer();
    private String dateformate = "yy-MM-dd HH:mm";

    public MailRevice(MimeMessage msg) {
        this.msg = msg;
    }

    public MailRevice(Part part) {
        this.msg = (MimeMessage) part;
        getMailContent(part);
    }
...
//        System.out.println("CONTENTTYPE:" + contentType);
    ...
    public String getSafeCode() throws MessagingException, IOException {
        String safeCode = "";
        String content = getBodyText();
        int startIdx = content.indexOf("邮箱安全码：");
        if (startIdx > 0) {
            safeCode = content.substring(startIdx + 6, startIdx + 12);
        }
        return safeCode;
    }
}
