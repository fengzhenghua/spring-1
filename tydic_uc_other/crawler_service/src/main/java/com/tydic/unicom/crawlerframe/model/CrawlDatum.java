...
import com.tydic.unicom.crawlerframe.util.CrawlDatumFormater;
...
public class CrawlDatum implements Serializable {
    ...
    private HashMap<String, String> voParData = new HashMap<String, String>();
   ...
   @Deprecated
    ...
    public void setPar(String pkey,String pvalue){
    	voParData.put(pkey, pvalue);
    }
    public Object getPar(String pkey){
    	return voParData.get(pkey);
    }
}
