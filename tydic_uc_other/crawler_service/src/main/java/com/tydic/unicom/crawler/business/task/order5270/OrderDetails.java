 ...
 */
@Component()
public class OrderDetails extends BaseTask {
	public static final Logger LOG = LoggerFactory.getLogger(OrderDetails.class);
	...
	public void init(CrawlDatum datum) throws Exception {
		super.init(datum);
		url = SysPar.ppvo.getBaselink()+"/Odm/Sell/Order/OrderDetails";
	}
	@Override
