...
@Service
public class SafetyCodePhone extends BaseTask {
	
	public static final Logger LOG = LoggerFactory.getLogger(SafetyCodePhone.class);
	public String requestcookie="";
	
	public SafetyCodePhone() {
		super();
	}
...
//			LOG.info("=============================   kaishi request!");
			...
			mall.setPar("staffCode", SysUtil.getStr(crawlDatum.getPar("CRAWMU_NAME")));
			LOG.debug("=============================   staffCode   :"+crawlDatum.getPar("CRAWMU_NAME"));
			mall.setPar("sendType","phone");
			LOG.debug("=============================    sendType   :phone");
