 ...
 */
package com.tydic.unicom.crawlerframe.model;
...
import com.tydic.unicom.crawlerframe.util.CharsetDetector;
...
public class Page {
    ...
    private MallHttpResponse response = null;
...
//    }
    ...
    public Page(CrawlDatum datum, MallHttpResponse response) {
...
//    		return content;
    ...
    public MallHttpResponse response() {
        return response;
    }

    public void response(MallHttpResponse response) {
        this.response = response;
    }
    @Deprecated
    public MallHttpResponse getResponse() {
        return response;
    }

    @Deprecated
    public void setResponse(MallHttpResponse response) {
        this.response = response;
    }
