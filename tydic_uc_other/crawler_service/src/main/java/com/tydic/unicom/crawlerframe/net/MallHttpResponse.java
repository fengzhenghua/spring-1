 ...
 * @author hu
 */
public class MallHttpResponse {

	public static final org.slf4j.Logger LOG = LoggerFactory.getLogger(MallHttpResponse.class);
	...
	public MallHttpResponse(URL url) {
		this.url = url;
	}
	...
	public void setCookie(String cooki) {
		cookie = cooki;
	}
