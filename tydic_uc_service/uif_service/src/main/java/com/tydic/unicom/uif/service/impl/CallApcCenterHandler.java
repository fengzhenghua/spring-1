...
@Component("callApcCenterHandler")
public class CallApcCenterHandler implements ICallSystemByUifServ {

	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Value("${apc.service.url}")
	private String url;
	...
	public UocMessage callOtherSystem(String paramsValueJson,
		...
		logger.info("进入调用Apc服务,入参" + paramsValueJson);
