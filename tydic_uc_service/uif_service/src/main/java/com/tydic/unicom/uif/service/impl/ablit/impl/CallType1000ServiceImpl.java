 ...
 * @ClassName callSendPhotoAbilitService
 * @Description 重庆本地接口能力平台调用 interface_type = 1000
 * @version V1.0
 */
@Component("callSendPhotoAbilitService")
public class CallType1000ServiceImpl extends BaseCallLocalAbilityPlat{
	...
	public CallLocalAbilitPlatVo buildCallMessage(AbilitReqestVo requestVo) {
		...
		tapService.setCommUrl(uifPropertiesParamVo.getSendPhotoUrl());
		tapService.setToken(uifPropertiesParamVo.getSendPhotoToken());
