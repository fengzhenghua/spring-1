...
@Component("callUgcCenterHandler")
public class CallUgcCenterHandler implements ICallSystemByUifServ {

	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Value("${ugc.service.url}")
	private String url;
	...
	public UocMessage callOtherSystem(String paramsValueJson,
		...
		logger.info("进入调用Ugc服务,入参" + paramsValueJson);
