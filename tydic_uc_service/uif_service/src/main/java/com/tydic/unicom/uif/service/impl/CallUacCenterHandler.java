...
@Component("callUacCenterHandler")
public class CallUacCenterHandler implements ICallSystemByUifServ {

	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@Value("${uac.service.url}")
	private String url;

	@Override
	@SystemAuditLog
	public UocMessage callOtherSystem(String paramsValueJson,
			List<String> params) {
		UocMessage message = new UocMessage();
		logger.info("进入调用UaC服务,入参" + paramsValueJson);
