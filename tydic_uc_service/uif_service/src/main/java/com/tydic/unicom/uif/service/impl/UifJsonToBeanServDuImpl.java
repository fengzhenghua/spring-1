...
@Service("UifJsonToBeanServDu")
public class UifJsonToBeanServDuImpl implements UifJsonToBeanServDu{
Logger logger = Logger.getLogger(UifJsonToBeanServDuImpl.class);
