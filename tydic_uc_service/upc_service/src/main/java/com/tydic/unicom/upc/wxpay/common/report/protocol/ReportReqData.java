package com.tydic.unicom.upc.wxpay.common.report.protocol;
...
public class ReportReqData {
     ...
     * @param key 签名key
     */
    public ReportReqData(String appid, String mchid, String subMchid, String key, String deviceInfo, String interfaceUrl,int executeTimeCost, String returnCode,String returnMsg,String resultCode,String errCode,String errCodeDes, String outTradeNo,String userIp){
