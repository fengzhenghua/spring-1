...
public class DownloadBillBusiness {
	...
	private static Logger logger = Logger.getLogger(DownloadBillBusiness.class);
    ...
    public void run(DownloadBillReqData downloadBillReqData,ResultListener resultListener) throws Exception {
        ...
        try {
            ...
            ReportReqData reportReqData = new ReportReqData(
            		downloadBillReqData.getAppid(),
            		downloadBillReqData.getMch_id(),
            		downloadBillReqData.getSub_mch_id(),
            		downloadBillReqData.getKey(),
