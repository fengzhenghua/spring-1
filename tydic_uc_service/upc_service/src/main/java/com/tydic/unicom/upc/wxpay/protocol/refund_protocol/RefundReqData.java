package com.tydic.unicom.upc.wxpay.protocol.refund_protocol;
...
public class RefundReqData {
     ...
     */
    public RefundReqData(String appid, String mchid, String key,String transactionID,String outTradeNo,String deviceInfo,String outRefundNo,int totalFee,int refundFee,String opUserID,String refundFeeType){
