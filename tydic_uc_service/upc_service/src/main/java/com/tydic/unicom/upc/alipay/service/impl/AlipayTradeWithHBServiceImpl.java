package com.tydic.unicom.upc.alipay.service.impl;
...
import com.tydic.unicom.upc.alipay.config.Constants;
...
import com.tydic.unicom.upc.alipay.service.impl.hb.HbListener;
import com.tydic.unicom.upc.alipay.service.impl.hb.TradeListener;
...
public class AlipayTradeWithHBServiceImpl extends AbsAlipayTradeService {
    ...
    public static class ClientBuilder {
        ...
        public AlipayTradeWithHBServiceImpl build(String appid, String privateKey, String alipayPublicKey) {
            if (StringUtils.isEmpty(gatewayUrl)) {
                gatewayUrl = Configs.getOpenApiDomain(); // 与mcloudmonitor网关地址不同
            }
            this.appid = appid;
