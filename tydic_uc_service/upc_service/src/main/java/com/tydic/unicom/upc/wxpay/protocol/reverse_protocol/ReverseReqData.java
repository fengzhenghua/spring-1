package com.tydic.unicom.upc.wxpay.protocol.reverse_protocol;
...
public class ReverseReqData {
    ...
    public ReverseReqData(String appid, String mchid, String key,String transactionID,String outTradeNo){
