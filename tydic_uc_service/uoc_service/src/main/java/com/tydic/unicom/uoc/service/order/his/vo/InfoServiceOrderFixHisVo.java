...
public class InfoServiceOrderFixHisVo extends BaseVo{
	...
	private String machine_nbr;
	private String stardand_addr_id;
	private String install_address;
	private String nbr_area_code;
	...
	public String getMachine_nbr() {
		return machine_nbr;
	}
	public void setMachine_nbr(String machine_nbr) {
		this.machine_nbr = machine_nbr;
	}
	public String getStardand_addr_id() {
		return stardand_addr_id;
	}
	public void setStardand_addr_id(String stardand_addr_id) {
		this.stardand_addr_id = stardand_addr_id;
	}
	...
	public String getNbr_area_code() {
		return nbr_area_code;
	}
	public void setNbr_area_code(String nbr_area_code) {
		this.nbr_area_code = nbr_area_code;
	}
