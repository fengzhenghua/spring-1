...
public class InfoOfrOrderInvoiceHisVo extends BaseVo{
	...
	public String getInvoice_engine() {
		return invoice_engine;
	}
	public void setInvoice_engine(String invoice_engine) {
		this.invoice_engine = invoice_engine;
	}
