...
public class InfoServiceOrderSimCardHisVo extends BaseVo{
	...
	private String card_data_proc_id;
	...
	public String getCard_data_proc_id() {
		return card_data_proc_id;
	}
	public void setCard_data_proc_id(String card_data_proc_id) {
		this.card_data_proc_id = card_data_proc_id;
	}
