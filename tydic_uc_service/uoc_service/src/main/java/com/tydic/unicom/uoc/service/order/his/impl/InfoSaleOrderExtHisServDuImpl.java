...
@Service("InfoSaleOrderExtHisServDu")
public class InfoSaleOrderExtHisServDuImpl implements InfoSaleOrderExtHisServDu {

	Logger logger = Logger.getLogger(InfoSaleOrderExtHisServDuImpl.class);
	...
	@Override
	public InfoSaleOrderExtHisVo getInfoSaleOrderExtHisBySaleOrderNo(
			InfoSaleOrderExtHisVo vo) throws Exception {
		InfoSaleOrderExtHisPo InfoSaleOrderExtHisPo =new InfoSaleOrderExtHisPo();
		BeanUtils.copyProperties(vo,InfoSaleOrderExtHisPo);		
		InfoSaleOrderExtHisPo ePo = infoSaleOrderExtHisServ.queryInfoSaleOrderExtHisBySaleOrderNo(InfoSaleOrderExtHisPo);		
		if(ePo != null){
			InfoSaleOrderExtHisVo ordVo = new InfoSaleOrderExtHisVo();
	...
	@Override
	public Map<String, Object> getAttrDesc(InfoSaleOrderExtHisVo vo,
