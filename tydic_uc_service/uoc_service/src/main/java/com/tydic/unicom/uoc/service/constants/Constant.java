package com.tydic.unicom.uoc.service.constants;
...
public class Constant {
	...
	//表名code_task_pkg_app
	public static final String CODE_TASK_PKG_APP = "codeTaskPkgApp";
	//表名code_task_pkg_define
	public static final String CODE_TASK_PKG_DEFINE = "codeTaskPkgDefine";
	//表名code_task_pkg_design
	public static final String CODE_TASK_PKG_DESIGN = "codeTaskPkgDesign";
	//表名PROC_TASK_ASSIGN_RULE
	public static final String PROC_TASK_ASSIGN_RULE="procTaskAssignRule";
	//表名PROC_TASK_ASSIGN_RULE
	public static final String PROC_TASK_RULE_SPEC="procTaskRuleSpec";
	// 表名PROC_TASK_RULE_DEPART
	public static final String PROC_TASK_RULE_DEPART = "procTaskRuleDepart";
