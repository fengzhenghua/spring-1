...
public interface CqSFServiceServDu {
	...
	/**顺丰发货(无流程)*/
	public UocMessage sendLogisticsInfoNoProcessCq(String jsession_id,String serv_order_no,String d_contact,String d_tel,String d_address, String j_tel, String j_contact, String j_address, String name, String remark, String cod_account,
