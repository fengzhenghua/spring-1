...
public class InfoServiceOrderProdMapHisVo extends BaseVo{
	...
	public String getRoam_level() {
		return roam_level;
	}
	public void setRoam_level(String roam_level) {
		this.roam_level = roam_level;
	}
	public String getCall_level() {
		return call_level;
	}
	public void setCall_level(String call_level) {
		this.call_level = call_level;
	}
