...
<%-- 	<link href="<%=fullPath%>css/common/public.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="<%=fullPath%>js/appBusi/appPayWeixinQrCode.js"></script>
</head>
<body>
	<div class="main-page">
		<div class="top">
			<div class="top_left" id="clickBack"><span class="top_left_icon"></span><span>返回</span></div>
			<div class="top_title">微信二维码支付</div>
		</div>
		...
		<section>
			...
			<div class="prompt">
				...
				<P class="bar-prompt">请使用微信扫一扫上面的二维码进行支付</P>	
			</div>		
		</section>
	</div>
	<!-- 支付成功 -->
