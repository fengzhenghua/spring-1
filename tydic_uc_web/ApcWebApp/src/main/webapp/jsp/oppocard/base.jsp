...
<script type="text/javascript" src="../../js/pc/oppocard/base.js" ></script>
...
<div class="main-page" style="display:block;" id="main-page">
	<ul class="content char4">
        ...
        <li class="c-li clearfix background">
			...
			<div class="lianxi l">身份证：<input class="input-ie6" type="text" placeholder="" value="" id="id_number"></div>
			<div class="lianxi l">联系电话：<input class="input-ie6" type="text" placeholder="" value="" id="connect_phone"></div>
		</li>
        ...
        <li class="c-li clearfix background">
       		<div class="lianxi l ml-3 ml-ie6">号码归属：
				<span><span class="sheng fs" id ="numAssignValue"></span></span>
				<!-- <span class="icon-right icon-more i-ml i-ml-left"></span> -->
			</div>
		...
		<li class="c-li">
            ...
            <span class="c-shuru">请选择发货方式和发展人</span>
        </li>
        <li class="c-li clearfix background">
        	<span class="lianxi ml-3">选择发货方式：</span>
        	<select  id="send_type">
        		<option value="">请选择</option>
        		<option value="1">货到付款</option>
        		<option value="2">快递发货</option>
        	</select>
        	<span class="lianxi ml-3">选择发展人：</span>
        	<select  id="dev_option">
        		<option value="">请选择</option>
        	</select>
        </li>
        <!-- <li class="c-li clearfix background">
       		<div class="lianxi l ml-3 ml-ie6">发货方式：
				<span><span class="sheng fs" id ="">货到付款</span></span>
				<span class="icon-right icon-more i-ml i-ml-left"></span>
			</div>
		</li> -->
		
		<li class="c-li" style="display:none;">
			<span class="c-one ">3</span>
            <span class="c-shuru">请选择发展人</span>
        </li>
        <li class="c-li clearfix background" style="display:none;">
			<div class="lianxi l lx-ml lx-ie6" id="selectRecomPerson">选择发展人：
				<span class="fs recom_person" id="recom_person"></span>
				<span class="icon-right icon-more i-ml i-ml-right"></span>
			</div>
		</li>
		...
		<li class="c-li">
            ...
            <span class="c-shuru">请填写配送地址</span>
        </li>
        <li class="c-li clearfix background">
...
<!-- <div class="dialog gray-bgcolor" id="number_pop" style="display:none;">
    <div class="info text-center gray-bgcolor">号码选择</div>
    
    <div class="search gray-bgcolor" id="query_content">
	   	<div>
            <a href="javascript:void(0);" class="s red-bgcolor" id="searchData">查询</a>
        </div>
		 <div class="search-icon" id = "searchData"></div>
		<div class="search-icon search-icon-left" id = "delete"></div>
		<div class="search-text search-text-left" id = "searchInput">
			<div><input id="searchNumberformat" type="text" class="text" maxlength="6" value="" placeholder="请输入0-6位数字查询"/></div>
		</div>		
		
	</div>

	 
	<ul class="content gray-bgcolor" >
    	<div id = "number_content">
        宁夏号码选择 2016-7-22 begin
        <div class="number_box">
            <div class="number_box_row">
                18577438854
            </div>
            <div class="number_box_row">
                18577438854
        ...
        <div class="float_center" style=" margin:0px 10px;">
            <div class="btn_ahead" style="height:40px;"></div>
            <span style="line-height:40px;"><span class="red" id="page_current">0</span>/<span id="page_total">0</span></span>
            <div class="btn_behind" style="height:40px;"></div>
        </div>
		
	</ul>
    
    <hr>
    <div class="btn" ><a href="###" id="hideNumber">返 回</a></div>
</div> -->
...
<!-- 地址选择 2016-12-19 begin -->
<div class="dialog " id="address_choose_dialog" style="display:none;">
    <div class="info text-center" id="addr_choice">地址选择</div>
    <input type="hidden" id="addr_name_p">
    <input type="hidden" id="addr_name_c">
    <input type="hidden" id="addr_name_a">
    <style >
		.dialog ul li {height:29px; line-height:29px; border-bottom:none; padding:0px 0px;}
		.tabs .thistab,.tabs .thistab a,.tabs .thistab a:hover{border-bottom: 1px solid #e60017!important;background-color:#e60017!important; color:#fff!important;}
	</style>
    <ul class="content">
        ...
        <div class="tabbox" id="tabbox">
                ...
                <ul class="tabs" id="tabs">
                    <li>
                    	<a href="javascript:void(0)" tab="tab1">省份</a>
                    </li>
                    <li>
                    	<a href="javascript:void(0)" tab="tab2">城市</a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" tab="tab3">城区</a>
                    </li>
                </ul>
                ...
                <ul class="tab_conbox">
                    <li id="tab1" class="tab_con">
                       ...
                       <div class="tab_list">
                       		...
                       		<div class="tabs_data">广东</div>
                            <div class="tabs_data">广西</div>
                            <div class="tabs_data">海南</div>
    ...
    <!--
	<hr>-->
    <div class="btn" style="display:none;" id="address_choose_exit"><a href="###">返回</a></div>
    
</div>
<!-- 地址选择 2016-12-19 end -->

<div id="docNumListDiv" style="display:none;" class="dialog">
	<ul id="docNumList">
...
<!-- dengjiao -->
	...
	<div class="modal_layer" belong="mask" id="selectNumber">
		...
		<div class="modal_box">
			<div class="modal_top">
				<span class="modal_title">选择号码</span><span class="modal_close">x</span>
				<div>
					<input id="searchNumberCondition" style="border:1px solid black;border-radius:4px;padding-left:5px;" type="text" maxlength="6" value="" placeholder="请输入0-6位数字查询"/>
					<a href="javascript:void(0);" id="searchNumber" class="btn btn_primary">查询</a>
				</div>
			</div>
	...
	<!-- 选择可选发展人-模态框 -->
	<div class="modal_layer" belong="mask" id="selectRecommendPerson">
		<div class="bg_cover"></div>
		<div class="modal_box">
			<div class="modal_top">
				<span class="modal_title">选择发展人</span><span class="modal_close">x</span>
			</div>
			<div class="modal_middle" style="bottom:10px;">
				<div class="detail_item">
					<ul class="detail_info_body mtop15">
						<li class="line">
							<div class="width100per">
								<ul class="number clearfix" id="recommendPerson">
	...
	<!-- 支付二维码弹出框 -->
<div class="dialog_small gray-bgcolor" id="pay_qr_code_pop" style="display:none;">
	<ul class="content">
    	<div class="gray-bgcolor">
        	<img src="" id="pay_qr"/>
		</div>
        <div class="float_center">
        	<div class="padding-lr" style="font-size:10px;color:red;" id="pay_tips"></div>
            <div class="padding-lr" style="font-size:10px;color:red;">请扫二维码进行微信支付，</div>
            <div class="padding-lr" style="font-size:10px;color:red;">支付完成前请不要关闭页面。</div>
        </div>
	</ul>
</div>
