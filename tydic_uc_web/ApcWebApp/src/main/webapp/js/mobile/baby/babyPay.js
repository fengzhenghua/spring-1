...
$(document).ready(function () {
	...
	accept_no = CACHE_UTIL.getSessionItem("accept_no");
	...
	total_fee=CACHE_UTIL.getSessionItem("total_fee");
	tb_account=CACHE_UTIL.getSessionItem("tb_account");
	accept_system=CACHE_UTIL.getSessionItem("accept_system");
	callback_url=CACHE_UTIL.getSessionItem("callback_url");
	ywb_id=CACHE_UTIL.getSessionItem("ywb_id");
...
function createUocOrder() {
	...
	total_fee=parseFloat(total_fee)+goodNumFee;
