...
<link href="<%=fullPath%>css/infoCustCareOrder.css" rel="stylesheet" type="text/css" />
			 ...
			 audit.rep_list_manager[value] = 
		            $("#rep_"+value).ligerGrid({
		                columns: [
		  		                ...
		  		                delayLoad:true,
		  		                url: application.fullPath + "noauthority/ReportCs/queryInfoCustCareOrder",
		  		              	//url: application.fullPath + "authority/reportForms/queryInfoCustCareOrder",
		  		                height:300,pageSize:30 ,rownumbers:false
		            });
		};
			...
			audit.rep_list_manager[value]  = 
		            $("#rep_"+value).ligerGrid({
		                columns: [	                
		  		                ...
		  		                delayLoad:true,
		  		                url: application.fullPath + "noauthority/ReportCs/queryInfoCustCareOrderMonthly",
		  		                height:300,pageSize:30 ,rownumbers:false
		            });
		};
		...
		*/
        ...
        audit.rpt_export = function () {
            ...
            if (audit_report_type == "operating_receipt"){
                ...
                post(application.fullPath + "noauthority/ReportCs/queryInfoCustCareOrderExcel",colNames);
            }
                ...
                post(application.fullPath + "noauthority/ReportCs/queryInfoCustCareOrderMonthlyExcel",colNames);
            }
        };
...
<body>
    ...
    <div class="show_title_bg">
        <div class="show_title"><!--<span class="crumb">当前位置：账号选择</span>-->客响报表<!--<span class="red">选择完一项后，才能选择下面一项的内容，否则下面全部置灰无法选择；仅可以做单选。</span>-->
        </div>
    </div>
