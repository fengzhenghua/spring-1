...
<head>
	...
	<script type="text/javascript" src="<%=fullPath %>/js/sale_selected_code_3g.js"></script>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<title>选择3G普通套餐及活动</title>
</head>
<body>
	...
	<input type="hidden" id="pay_flag" 	value="${codeOfrNumberVo.pay_flag }">	<!-- 付费类型 -->
  	<div class="crumbs">当前位置: 
  		<a href="javascript:void(0);">销售(3G)</a>> 
  	...
  	<div class="sale_content">
  		<div class="right">
			...
			<form action="saleOpen" id="saleOpenForm" method="post">
				<!-- 前一页传过来的参数 -->
				<input type="hidden" id="acc_nbr_result" 		value="${codeOfrNumberVo.acc_nbr}"		name="acc_nbr"  >		<!--设备号码  -->
				<input type="hidden" id="acc_nbr_fee_result" 	value="${codeOfrNumberVo.fee}"			name="acc_nbr_fee" >	<!--号码预存话费  -->
				<input type="hidden" 							value="${codeOfrNumberVo.good_type }" 	name="good_type" >		<!-- 靓号类型 -->
				<input type="hidden" 							value="${codeOfrNumberVo.tele_type }"	name="tele_type"  >		<!--电信类型  -->
				<input type="hidden" 							value="${codeOfrNumberVo.pay_flag }"	name="prepay_flag" >	<!--付费标志 -->
				<!-- 套餐字段 -->
