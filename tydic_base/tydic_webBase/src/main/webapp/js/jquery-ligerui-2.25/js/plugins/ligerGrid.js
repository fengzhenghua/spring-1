...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        single:false,							//是否为单选，true 单选 false为多选 add by chenly
        ...
        buttonType:"",							//右下角按钮类型 目前类型  confirm(确认),excel(导出excel按钮) add by chenly
        buttonEvent:null						//按钮事件 add by chenly
    };
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            if(p.buttonType == "excel"){
            	   gridhtmlarr.push("                <div class='l-bar-group  l-bar-message l-bar-report'><a href='javascript:void(0);' class='big'>导出到EXCEL</a></div>");//原先div里的是<span class='l-bar-text'>
            }else if(p.buttonType == "confirm"){
            	   gridhtmlarr.push("                <div class='l-bar-group  l-bar-message l-bar-report'><a href='javascript:void(0);' class='big'>确认</a></div>");//原先div里的是<span class='l-bar-text'>
            }        
            ...
            //右下角按钮
            g.reportbutton  = $(".l-bar-report",g.grid);
        ...
        */
        ...
        _bulid: function ()
        {
            ...
            g._setEvent();
            //初始化右下角按钮事件
            g._initReportButton();//add by chenly
        },
        _initReportButton: function(){
        	var g = this, p = this.options;
        	if(typeof p.buttonEvent == "function"){
        		g.reportbutton.click(p.buttonEvent);
        	}
        ...
        _showData: function ()
        {
            ...
            if (!data || !data.length)
            {
                ...
                $("<div style='color:red;'>没有数据</div>").addClass("l-grid-body-inner").appendTo(g.gridbody).css({
        ...
        _setEvent: function ()
        {
            ...
            {
                $("span",this).addClass("l-bar-button-over");
            }, function ()
            {
                $("span",this).removeClass("l-bar-button-over");
            });
            //列拖拽支持
        ...
        select: function (rowParm)
        {
            ...
            if (p.single) //单选 modify by chenly
            {
