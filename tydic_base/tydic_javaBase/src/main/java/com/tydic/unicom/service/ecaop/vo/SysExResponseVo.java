 ...
 * @author yangfei
 * @date: 2014年11月6日 下午2:21:25
 * @Title: SysExResponseRo.java
...
/**
 * <p></p>
 * @author yangfei 2014年11月6日 下午2:21:25
 * @ClassName SysExResponseRo
 * @Description TODO 系统异常 HTTP返回码=600
 * @version V1.0   
 * @modificationHistory=========================逻辑或功能性重大变更记录
 * @modify by user: {修改人} 2014年11月6日
 * @modify by reason:{方法名}:{原因}
 */
public class SysExResponseVo extends BaseResponseVo{
	/** 
    * @Fields serialVersionUID : TODO
    */ 
    private static final long serialVersionUID = -1248311617960161794L;
	/**
	 * 应答编码
	 */
	private String code;
