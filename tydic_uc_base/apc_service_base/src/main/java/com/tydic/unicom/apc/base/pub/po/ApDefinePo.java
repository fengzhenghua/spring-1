...
public class ApDefinePo extends BasePo{
	...
	public String toString() {
		return "ApDefinePo [ap_id=" + ap_id + ", ap_name=" + ap_name + ", ap_desc=" + ap_desc + ", ap_url=" + ap_url
				+ ", province_code=" + province_code + ", area_code=" + area_code + ", state=" + state + ", bind_oper="
				+ bind_oper + ", create_staff=" + create_staff + ", create_time=" + create_time + ", region=" + region
				+ ", chnl_code=" + chnl_code + ", eff_date=" + eff_date + ", exp_date=" + exp_date + ", ap_type="
				+ ap_type + "]";
	}
