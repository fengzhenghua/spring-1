...
@Service("InfoServiceOrderGoodNbrHisServ")
public class InfoServiceOrderGoodNbrHisServImpl extends BaseServImpl<InfoServiceOrderGoodNbrHisPo> implements InfoServiceOrderGoodNbrHisServ{
	...
	public boolean createInfoServiceOrderGoodNbrHisPo(InfoServiceOrderGoodNbrHisPo po)throws Exception{
		...
		create(InfoServiceOrderGoodNbrHisPo.class,po);
		return true;

	}

	@Override
	public List<InfoServiceOrderGoodNbrHisPo> queryInfoServiceOrderGoodNbrHisByOrderNo(
			InfoServiceOrderGoodNbrHisPo po) throws Exception {
		String order_no="";
		...
		Condition con = Condition. build("queryInfoServiceOrderGoodNbrHisByOrderNo").filter(po.convertThis2Map());
		List<InfoServiceOrderGoodNbrHisPo> list = query(InfoServiceOrderGoodNbrHisPo.class,con);      
