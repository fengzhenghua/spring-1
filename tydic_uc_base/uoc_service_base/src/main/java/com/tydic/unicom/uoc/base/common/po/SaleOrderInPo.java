...
public class SaleOrderInPo extends BasePo{
	/**
	 * 
	 */
	...
	private String tache_code_flag;
	...
	public String getTache_code_flag() {
		return tache_code_flag;
	}
	public void setTache_code_flag(String tache_code_flag) {
		this.tache_code_flag = tache_code_flag;
	}
