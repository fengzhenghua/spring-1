...
public class InfoServiceOrderTerminalHisPo extends BasePo{
	...
	public String getTerminal_color() {
		return terminal_color;
	}
	public void setTerminal_color(String terminal_color) {
