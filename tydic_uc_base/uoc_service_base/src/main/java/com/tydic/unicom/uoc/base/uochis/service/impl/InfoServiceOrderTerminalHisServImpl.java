...
@Service("InfoServiceOrderTerminalHisServ")
public class InfoServiceOrderTerminalHisServImpl  extends BaseServImpl<InfoServiceOrderTerminalHisPo> implements InfoServiceOrderTerminalHisServ{
	...
	public boolean createInfoServiceOrderTerminalHisPo(InfoServiceOrderTerminalHisPo po)throws Exception{
		...
		create(InfoServiceOrderTerminalHisPo.class,po);
		return true;
	}

	@Override
	public List<InfoServiceOrderTerminalHisPo> queryInfoServiceOrderTerminalHisByOrderNo(
			InfoServiceOrderTerminalHisPo po) throws Exception {
		String order_no="";
		...
		Condition con = Condition. build("queryInfoServiceOrderTerminalHisByOrderNo").filter(po.convertThis2Map());
		List<InfoServiceOrderTerminalHisPo> list = query(InfoServiceOrderTerminalHisPo.class,con);      
