...
@Service("InfoServiceOrderGuarantorHisServ")
public class InfoServiceOrderGuarantorHisServImpl extends BaseServImpl<InfoServiceOrderGuarantorHisPo> implements InfoServiceOrderGuarantorHisServ{
	...
	public boolean createInfoServiceOrderGuarantorHisPo(InfoServiceOrderGuarantorHisPo po)throws Exception{
		...
		create(InfoServiceOrderGuarantorHisPo.class,po);
		return true;

	}

	@Override
	public List<InfoServiceOrderGuarantorHisPo> queryInfoServiceOrderGuarantorHisByOrderNo(
			InfoServiceOrderGuarantorHisPo po) throws Exception {
		String order_no="";
		...
		Condition con = Condition. build("queryInfoServiceOrderGuarantorHisByOrderNo").filter(po.convertThis2Map());
		List<InfoServiceOrderGuarantorHisPo> list = query(InfoServiceOrderGuarantorHisPo.class,con);      
